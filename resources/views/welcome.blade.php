                ...
                <div class="p-6 text-center">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-5 gap-4 max-w-3xl mx-auto">
                            ...
                            <div class="bg-orange-100 dark:bg-orange-900 rounded-lg p-4">
                    ...
                    <!-- Coming Soon Message -->
                    <div class="text-6xl font-extrabold text-gray-800 dark:text-gray-200 mb-6">
                        {{ __('Coming Soon !!!') }}
                    </div>
                    ...
                    <div class="max-w-2xl mx-auto mb-8">
                        <div class="h-4 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div class="h-full bg-gradient-to-r from-blue-500 to-purple-600" style="width: 50%"></div>
                        </div>
                        <div class="text-sm text-gray-600 dark:text-gray-400 mt-2">50% Complete</div>
                    </div>
                </div>
            </div>
        </div>
